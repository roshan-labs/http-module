...
export class Http {
  ...
  public get<R = any>(url: string, params: Params = {}, options: FetchOptions = {}) {
    return this.request<R>(
      url,
      defu<FetchOptions, FetchOptions>({ method: 'GET', params }, options, this.options)
    )
  }
  ...
  public useGet<R = any>(url: string, params: Params = {}, options: UseFetchOptions<R> = {}) {
    return this.useRequest<R>(
      url,
      defu<UseFetchOptions<R>, UseFetchOptions<R>>({ method: 'GET', params }, options, this.options)
    )
  }
  ...
  public post<R = any>(url: string, params: Params = {}, options: FetchOptions = {}) {
    return this.request<R>(
      url,
      defu<FetchOptions, FetchOptions>({ method: 'POST', body: params }, options, this.options)
    )
  }
  ...
  public usePost<R = any>(url: string, params: Params = {}, options: UseFetchOptions<R> = {}) {
    return this.useRequest<R>(
      url,
      defu<UseFetchOptions<R>, UseFetchOptions<R>>(
  ...
  public put<R = any>(url: string, params: Params = {}, options: FetchOptions = {}) {
    return this.request<R>(
      url,
      defu<FetchOptions, FetchOptions>({ method: 'PUT', body: params }, options, this.options)
    )
  }
  ...
  public delete<R = any>(url: string, params: Params = {}, options: FetchOptions = {}) {
    return this.request<R>(
      url,
      defu<FetchOptions, FetchOptions>({ method: 'DELETE', body: params }, options, this.options)
    )
  }
}
